...
public class BigFileReader {
	...
	private Set<StartEndPair> startEndPairSets;
	...
	private BigFileReader(File file, IHandle handle, String charset, int bufferSize, int threadSize) {
		...
		startEndPairSets = new HashSet<BigFileReader.StartEndPair>();
	}
	...
	public void start() {
		...
		cyclicBarrier = new CyclicBarrier(startEndPairSets.size(), new Runnable() {
		...
		for (StartEndPair pair : startEndPairSets) {
